...
export default {
  ...
  // 组件在挂载完成的时候，就立马发送请求获取数据，存储到vuex里面，而不是直接在vue组件
  mounted() {
  ...
  methods: {
    ...
    toSearch(event) {
      // event是什么，就是浏览器调用函数传递过来的时间对象，代表你传递的$event，只能在模板里面出现
